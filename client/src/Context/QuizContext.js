const quizData = [
    ...
    //   "options": [
    //     "A. A type of payment card that allows you to spend money that you have in your bank account",
    //     "B. A type of credit card",
    //     "C. A type of investment",
    //     "D. A type of loan"
    //   ],
    ...
    //   "options": [
    //     "A. Interest that is calculated on both the original amount of money you deposit and the interest that has been earned on that money",
    //     "B. Interest that is calculated only on the original amount of money you deposit",
    //     "C. Interest that is calculated only on the interest that has been earned on your savings",
    ...
    //   "text": "What is a bond?",
    //   "options": [
    //     "A. A type of investment where you lend money to a company or government in exchange for regular interest payments",
    //     "B. A type of stock",
